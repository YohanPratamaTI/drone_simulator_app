...
class CustomInfoWindowAdapter(private val context: Context) : GoogleMap.InfoWindowAdapter {
    ...
    override fun getInfoWindow(marker: Marker): View? {
        ...
        val batteryPercentage: TextView = view.findViewById(R.id.tv_batteryPercentage)
        ...
        height.text = "Ketinggian: ${data?.height}m"
        batteryPercentage.text = "Daya Baterai: ${data?.batteryPercentage}%"
